...
- Agent Studio extension installed
...
3. Type "Agent Studio: Open Editor"
4. Press Enter
...
**Solutions**:
1. **Update extension**: Ensure you're using Agent Studio v0.4.0 or later
2. **Restart VSCode**: Close and reopen VSCode
3. **Check extension status**: View → Extensions → Search "Agent Studio"
...
1. Open the Agent Studio repository
