...
```json
{
  "schemaVersion": "1.0.0",
  "metadata": {
    "description": "Workflow schema for Agent Studio",
    "maxNodes": 50,
    "supportedNodeTypes": [...]
  },
  "nodeTypes": {
...
**Rationale**:
- **Clear role**: "You are an expert workflow designer for Agent Studio"
...
```typescript
const prompt = `
You are an expert workflow designer for Agent Studio.
