...
このドキュメントは、Agent Studio のデータモデル定義を記述します。主要なエンティティ、フィールド、関係性、バリデーションルール、状態遷移を定義します。
...
- Research Report: `/specs/001-agent-studio/research.md`
